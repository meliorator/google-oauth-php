...
class Googleplus {
	...
	public function __construct() {
		...
		require DIR_ROOT . DS . 'vendor' . DS .'meliorator/google-oauth-php/apiClient.php';
		require DIR_ROOT . DS . 'vendor' . DS .'meliorator/google-oauth-php/contrib/apiOauth2Service.php';
	...
	public function loginURL($callbackParams = '') {
	    if($callbackParams){
	        $this->client->setState($callbackParams);
        }
